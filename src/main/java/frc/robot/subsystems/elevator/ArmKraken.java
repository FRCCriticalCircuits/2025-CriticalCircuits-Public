...
public class ArmKraken implements ArmIO {
  ...
  public void updateInputs(ArmIOInputs inputs, boolean coralDetected, boolean algaeDetected) {
    ...
    SmartDashboard.putNumber("targetAngle", this.targetIORotation.getRotations());
    SmartDashboard.putNumber("realAngle", this.m_anglerMotor.getPosition().getValueAsDouble());
  }
  ...
  public void setVoltage(double v) {
    m_anglerMotor.setVoltage(v);
  }

  public double getVelocity() {
    return m_anglerMotor.getVelocity().getValueAsDouble();
  };
